                                        ...
                                        $grandchild=$this->menu_model->getchild($v['id']);
                                            ...
                                            if(empty($grandchild)){
                                                ...
                                                foreach ($grandchild as $kunci => $val){
                                                    ...
                                                    // echo "<li><a href='#'   data-remote-target='#ajax-remote' data-load-remote='".$url."getdatatables'>".$val['title']."</a>";
                                                    echo '<a class="btn btn-primary btn-lg" href="#" data-load="'.$url.'getdatatables" data-table="'.$url.'tables" data-remote-target="#ajax-remote">'.$val['title'].'</a>';
                                                }
                                                echo "</ul>";
                                                echo "</li>";
