                                         ...
                                         <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <?php echo form_dropdown('id_barang[]',$opt_barang,'','id="id_barang" class="kdbarang input-lg form-control" placeholder="Enter id_barang"'); ?>
                                                        </div>
                                                        <span class="input-group-btn">
                                            ...
                                            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                                                ...
                                                <?php echo form_label('Jumlah: ','jumlah_satuan',array('class'=>'control-label')); ?>
                                                    ...
                                                    <div class="controls">
                                                    <?php echo form_input('jumlah_satuan[]','','id="jumlah_satuan" class="input-lg form-control" placeholder="Enter jumlah_satuan"'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                                                ...
                                                <?php echo form_label('Satuan : ','id_satuan',array('class'=>'control-label')); ?>
                                                        ...
                                                        <div class="controls">
                                                        <?php echo form_dropdown('id_satuan[]',$opt_satuan,'','id="id_satuan" class="satuan input-lg form-control" placeholder="Enter id_satuan"'); ?>
                                                        </div>
