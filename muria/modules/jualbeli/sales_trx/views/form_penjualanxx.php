                    ...
                    <?php echo form_open(base_url().'salex_trx/submit',array('id'=>'addform','role'=>'form','class'=>'form')); ?>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            ...
                            <div id="bypo" style="<?php echo $display; ?>">
                                <div class="form-group">
                                    <?php echo form_label('#Faktur SO: ','faktur_so',array('class'=>'control-label')); ?>
                                    <div class="input-group">
                                        <span class="input-group-btn">
                                        ...
                                        <div class="controls">
                                            ...
                                            <?php echo form_input('faktur_so',set_value('faktur_so', isset($faktur_so) ? $faktur_so : ''),'id="faktur_so" class="form-control" readonly placeholder="Masukkan #Faktur PO"'); ?>
                                        </div>
