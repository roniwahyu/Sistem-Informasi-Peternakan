...
class Sales_order_detail_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('sales_order_detail', $limit, $uri);
    ...
    function get_one($id_detail) {
        ...
        $result = $this->db->get('sales_order_detail');
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id_detail, '.$value.' from sales_order_detail order by id_detail asc');
