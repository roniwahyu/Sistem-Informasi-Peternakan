...
class Purchase_request_detail_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('purchase_request_detail', $limit, $uri);
    ...
    function save() {
           $data = array(
            ...
            'jumlah_dipesan' => $this->input->post('jumlah_dipesan', TRUE),
    ...
    function save_detail($data){
        $this->db->insert('purchase_request_detail_detail',$data);
    }
    function update($id_detail) {
       ...
       'datetime' => $this->input->post('datetime', TRUE),
        ...
        $this->db->where('id_detail', $id_detail);
        $this->db->update('purchase_request_detail', $data);
    ...
    function delete_detail($id=null) {
        ...
        $this->db->delete('purchase_request_detail_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id_detail, '.$value.' from purchase_request_detail order by id_detail asc');
