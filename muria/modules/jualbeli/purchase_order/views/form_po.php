                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                        <span class="input-group-btn">
                                            <a class="add_supplier btn btn-default" title="Form Supplier Baru" data-form-desc="Form Penambahan Supplier Baru" data-form="supplier" data-toggle="modal" href='#modal-form' data-load-remote="<?php echo base_url('supplier/simple_forms/') ?>" data-remote-target="#modal-form .modal-body"><i class="fa fa-plus"></i></a>
                                        </span>
