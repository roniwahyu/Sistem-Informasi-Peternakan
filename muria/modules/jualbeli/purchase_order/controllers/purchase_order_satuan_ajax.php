    ...
    function edit($enkrip=null,$id){
            ...
            $(document).ready(function(){
                    ...
                    $("#Kode").change(function(){
                            var that = this,
                            v = $(this).val();
                            var urls="'.base_url('barang_satuan/satuan_barang/').'/"+v+"/";
                            alert(urls);
                ...
                $("body").on("click",".add_satuan",function(e){
                    e.preventDefault();
                    var $this = $(this);
                    var satuanid = $this.data("load-satuan");
                    var targets= $this.data("remote-target");
                    alert(satuanid);
                     if(satuanid) {
                        $($this.data("remote-target")).load(satuanid);
                ...
                $("#modal-satuan").on("shown.bs.modal", function(){
            ...
            $(document).ready(function(){
                ...
                $("body").on("click",".refresh_barang",function(e){
                 ...
                 $("body").on("click",".add_satuan",function(e){
                    ...
                    var $this = $(this);
                    // var satuanid = $this.data("load-satuan");
                    var satuanid = $this.attr("data-load-satuan");
                    var targets= $this.data("remote-target");
                    // alert(satuanid);
                    if(satuanid) {
                        $($this.data("remote-target")).load(satuanid);
                ...
                $("#modal-satuan").on("hidden.bs.modal", function(){
                  $("#modal-satuan .modal-body").html("<br>");
                }); 
                $("#modal-satuan").on("shown.bs.modal", function(){
                    var id=$("#addsatuan").attr("data-barang");
                    $.get("'.base_url('barang_satuan/getsatuan/').'/"+id, 
                        function(data, status){
                           if(data){
                                ...
                                // $("#Satuan1 option:not(:selected),#Satuan2 option:not(:selected)").attr("disabled",true); 
                                $("#Satuan1" ).find( "option[value="+d.Satuan1+"]" ).prop( {selected: true,disabled:false} ); 
                                $("#Satuan2" ).find( "option[value="+d.Satuan2+"]" ).prop( {selected: true,disabled:false} ); 
                                $("#Satuan3" ).find( "option[value="+d.Satuan3+"]" ).prop( {selected: true,disabled:false} ); 
                                $("#SatuanMax" ).find( "option[value="+d.SatuanMax+"]" ).prop( {selected: true,disabled:false} ); 
                                $("#SatuanMin" ).find( "option[value="+d.SatuanMin+"]" ).prop( {selected: true,disabled:false} ); 
                ...
                $("select#Satuan1").change(function(){
                    var that = this,
                    v = $(this).val();
                    $(".txt1").html(v);
                    alert(v);
                ...
                // $("#totalbayar").maskMoney({thousands:".", decimal:",", allowZero:true});
            });
            function gettotal(){
                var po=$("#faktur_po").val();
                $.get("'.base_url('purchase_order/get_po_detail_total/').'/"+po, 
