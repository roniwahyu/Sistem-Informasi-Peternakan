...
class purchase_order extends MX_Controller {
    ...
    function editx($enkrip=null,$id){
            ...
            $(document).ready(function(){
                    ...
                    var po=$("#faktur_po").val();
                    $.get("'.base_url('purchase_order/get_po_detail_total/').'/"+enkrip+"/"+po, 
                        function(datan, status){
                            if(datan>0){
                                $("#totalbayarx").val(accounting.formatMoney(datan,"Rp ",2,".",","));
                                $("#totalbayar").val(datan);
                    ...
                    var TempTbl=$(".tabletemp").DataTable({
                        ...
                        "ajax":{
                            "url":"'.base_url('purchase_order/get_po_detail/'.$this->enkrip().'/'.$po['faktur_po'].'/').'",
                            "dataType": "json"
                        },
                        "sServerMethod": "POST",
                        "bServerSide": true,
