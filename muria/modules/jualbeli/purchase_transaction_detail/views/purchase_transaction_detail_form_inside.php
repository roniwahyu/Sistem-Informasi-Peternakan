                    ...
                    <?php echo form_open(base_url().'purchase_transaction_detail/submit',array('id'=>'addform','role'=>'form','class'=>'form')); ?>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <?php echo form_input('id_pt','','id="id_pt" class="form-control" placeholder="Enter id_pt"'); ?>
                                </div>
                            </div>
