...
class Penyesuaian_detail_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('penyesuaian_detail', $limit, $uri);
    ...
    function get_one($id_detail) {
        ...
        $result = $this->db->get('penyesuaian_detail');
    ...
    function save_detail($data){
        $this->db->insert('penyesuaian_detail_detail',$data);
    }
    ...
    function delete_detail($id=null) {
        ...
        $this->db->delete('penyesuaian_detail_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id_detail, '.$value.' from penyesuaian_detail order by id_detail asc');
