...
<!-- <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 kelola" style="display:none"> -->
                    ...
                    <?php echo form_open(base_url().'jenis_barang/submit',array('id'=>'addform','role'=>'form','class'=>'form')); ?>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <?php echo form_input('parent','','id="parent" class="form-control" placeholder="Enter parent"'); ?>
                                </div>
                            </div>
