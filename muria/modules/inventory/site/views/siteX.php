...
<?php endif; ?>
				...
				<?php if(!isset($data)): ?>
					<div class="jumbotron home">
						<div class="container text-center">
							<h1>Aplikasi Kinerja Karyawan THL</h1>
							<h3>Menggunakan Metode SAW (Simple Additive Weighting) Dan Rating Scale</h3>
							<p>&nbsp;</p>
		...
		<?php elseif(isset($saw)): ?>
		<div class="row">
		
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h2>Hasil Penilaian Kinerja Pegawai Metode SAW  </h2>
				<?php echo $saw; ?>
				<hr>
			</div>
