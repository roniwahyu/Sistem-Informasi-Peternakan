                    ...
                    <?php echo form_open(base_url().'rute/submit',array('id'=>'addform','role'=>'form','class'=>'form')); ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                <?php echo form_label('rute : ','rute',array('class'=>'control-label')); ?>
                                <div class="controls">
                                <?php echo form_input('rute',set_value('rute', isset($default['rute']) ? $default['rute'] : ''),'id="rute" class="form-control" placeholder="Masukkan rute"'); ?>
                                </div>
                            </div>
