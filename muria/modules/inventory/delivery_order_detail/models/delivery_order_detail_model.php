...
class Delivery_order_detail_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('delivery_order_detail', $limit, $uri);
    ...
    function get_one($id_detail) {
        ...
        $result = $this->db->get('delivery_order_detail');
    ...
    function save_detail($data){
        $this->db->insert('delivery_order_detail_detail',$data);
    }
    function update($id_detail) {
       ...
       'datetime' => $this->input->post('datetime', TRUE),
        ...
        $this->db->where('id_detail', $id_detail);
        $this->db->update('delivery_order_detail', $data);
    ...
    function delete_detail($id=null) {
        ...
        $this->db->delete('delivery_order_detail_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id_detail, '.$value.' from delivery_order_detail order by id_detail asc');
