...
class mutasi_barang extends MX_Controller {
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            $this->datatables->select('id,faktur,faktur_reff,tanggal,id_asal,id_tujuan,keterangan,user_id,datetime,')
                            ->from('mutasi_barang');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('mutasi_barang/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id,faktur,faktur_reff,tanggal,id_asal,id_tujuan,keterangan,user_id,datetime,')
                            ->from('mutasi_barang');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('mutasi_barang/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id');
            $this->datatables->unset_column('id');
        endif;
    ...
    function enkrip(){
        ...
        // echo $this->session->userdata('mutasi_barang');
    }
    function isadmin(){
    ...
    function forms(){
        ...
        $this->load->view('mutasi_barang_form_inside');
    ...
    function tables(){
        $this->load->view('mutasi_barang_data');
    }
...
/** Module mutasi_barang Controller **/
