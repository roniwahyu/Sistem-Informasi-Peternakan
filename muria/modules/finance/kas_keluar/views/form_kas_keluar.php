                    ...
                    <?php echo form_open(base_url().'kas_keluar/submit',array('id'=>'addform_kas','role'=>'form','class'=>'form')); ?>
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            ...
                            <div class="form-group">
                                <?php echo form_label('Faktur Kas : ','faktur_kas',array('class'=>'control-label')); ?>
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="controls">
                                    <?php echo form_input('akun_kas',set_value('akun_kas', isset($default['akun_kas']) ? $default['akun_kas'] : ''),'id="akun_kas" class="form-control label_kas" readonly placeholder="Masukkan akun_kas"'); ?>
                                    </div>
                                    <span class="input-group-btn">
                             ...
                             <div class=" row panel panel-danger">
                                <div class="add_panel panel-body panel-heading">
                                    ...
                                    <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1">
                                        ...
                                        <button class="add_kas_keluar btn btn-lg btn-info"><i class="fa fa-plus fa2x"></i></button>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <?php echo form_input('nominal',set_value('nominal', isset($default['nominal']) ? $default['nominal'] : ''),'id="nominal" class="form-control hidden" readonly placeholder="Masukkan nominal"'); ?>
                                <?php echo form_input('nominalx',set_value('nominalx', isset($default['nominalx']) ? $default['nominalx'] : ''),'id="nominalx" class="form-control text-right" readonly style="font-size:20px;"readonly placeholder="Masukkan nominalx"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <?php if($act['baru']==1): ?>
                            <button id="save_kas_keluar" href="#modal-notif" data-toggle="modal" type="submit" data-dismiss="modal" class="btn btn-lg btn-success"><icon class="fa fa-floppy-o"></icon> Simpan</button>
