...
class Auth extends MX_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->library(array('Ion_auth/Ion_auth','Template'));
    ...
    function login()
    {
        ...
        if ($this->form_validation->run() == true)
        {
            ...
            if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
            {
                ...
                $lihat=$this->session->userdata('lihat');
                ...
                if($this->ion_auth->in_group(2)){
                    ...
                    redirect(base_url('admin/upt'), 'refresh');
    ...
    function change_password()
    {
        ...
        if ($this->form_validation->run() == false)
        {
            ...
            //render
             $this->data['view']='auth/change_password_validation_new_password_label';
            $this->data['title']='Dashboard';
            // $this->_render_page('auth/index', $this->data);
            $this->template->load_view('wrapper',$this->data);
    ...
    function edit_group_user($id){
        ...
        $this->template->set_layout('dashboard');
            $this->data['view']='auth/edit_group_user';
            $this->data['title']='Edit Group User';
            $this->template->load_view('wrapper',$this->data);
