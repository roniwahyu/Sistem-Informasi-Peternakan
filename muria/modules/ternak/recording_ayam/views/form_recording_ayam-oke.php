                    ...
                    <?php echo form_open(base_url().'recording_ayam/submit',array('id'=>'addform','role'=>'form','class'=>'form')); ?>
...
<span class="input-group-btn">
                      ...
                      <!--   <div class="col-sm-10">
                                        ...
                                        <div class="checkbox i-checks"><label> 
                                            <input type="checkbox" value="" checked=""> <i></i> Option two checked </label></div>
                                        ...
                                        <div class="tambah row">
                                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                    <?php echo form_dropdown('id_barang',$opt_ayam,'','id="id_barang" class="form-control input-lg" placeholder="Ayam"'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                    <?php echo form_input('jumlah_satuan',set_value('jumlah_satuan', isset($default['jumlah_satuan']) ? $default['jumlah_satuan'] : ''),'id="jumlah_satuan" class="form-control input-lg" placeholder="Jumlah"'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                                ...
                                                <div class="form-group">
                                                    <?php echo form_label('Umur (Hari): ','usia',array('class'=>'control-label')); ?>
                                                    <div class="controls">
                                                    <?php echo form_input('usia',set_value('usia', isset($default['usia']) ? $default['usia'] : ''),'id="usia" class="form-control input-lg" placeholder="Umur Ayam"'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-1 col-lg-1">
                                               ...
                                               <a href="#" class="btn-add btn btn-lg btn-block btn-primary"><i class="fa fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            </div>
