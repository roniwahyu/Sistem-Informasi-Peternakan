                    ...
                    <?php echo form_open(base_url().'recording_pakan_detail/submit',array('id'=>'addform','role'=>'form','class'=>'form')); ?>
                                                   
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <input type="hidden" value='' id="id_detail" name="id_detail">
                            
                            <div class="form-group">
                                <?php echo form_label('id_recording_pakan : ','id_recording_pakan',array('class'=>'control-label')); ?>
                                <div class="controls">
                                <?php echo form_input('id_recording_pakan',set_value('id_recording_pakan', isset($default['id_recording_pakan']) ? $default['id_recording_pakan'] : ''),'id="id_recording_pakan" class="form-control" placeholder="Masukkan id_recording_pakan"'); ?>
                                </div>
                            </div>
