                    ...
                    <?php echo form_open(base_url().'jenis_recording/submit',array('id'=>'addform','role'=>'form','class'=>'form')); ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                <?php echo form_label('akun_rekening : ','akun_rekening',array('class'=>'control-label')); ?>
                                <div class="controls">
                                <?php echo form_input('akun_rekening',set_value('akun_rekening', isset($default['akun_rekening']) ? $default['akun_rekening'] : ''),'id="akun_rekening" class="form-control" placeholder="Masukkan akun_rekening"'); ?>
                                </div>
                            </div>
